...
def get_hparams(init=True, stage=1):
    ...
    # parser.add_argument('-g', '--pretrained_s2G', type=str, required=False,default=None,help='pretrained ConVITS gererator weights')
    # parser.add_argument('-d', '--pretrained_s2D', type=str, required=False,default=None,help='pretrained ConVITS discriminator weights')
